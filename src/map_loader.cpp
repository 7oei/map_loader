...
std::string map_path = "/home/adachi/arav_data/hayashida_whole/hayashida_whole_ndt.pcd";
...
int main(int argc, char** argv)
{
  ...
  // Publishers
  points_map_pub = nh.advertise<sensor_msgs::PointCloud2>("/map_cloud", 10, true);
